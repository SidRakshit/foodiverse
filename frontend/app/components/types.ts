...
export type SceneType = 'campus' | 'burruss' | 'turner' | 'torgersen' | 'squires' | 'owens' | 'war_memorial' | 'cassell' | 'drillfield' | 'lane_stadium' | 'tots' | 'hokiehouse' | 'centros' | 'tots_upstairs' | 'edge';
