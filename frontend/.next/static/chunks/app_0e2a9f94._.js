...
class Player {
    ...
    update(deltaTime, inputHandler, scene) {
        ...
        let newY = this.y;
        this.isMoving = false;
        // Handle interaction input (Space or Enter key)
        if (inputHandler.wasKeyJustPressed('Space') || inputHandler.wasKeyJustPressed('Enter')) {
    ...
    handleInteraction(scene) {
        // Check if we're in the Hokie House and can interact with bartender
        if (scene.type === 'hokiehouse') {
            const hokieHouse = scene; // Cast to access bartender methods
            if (hokieHouse.interactWithBartender) {
                const dialogue = hokieHouse.interactWithBartender(this.x, this.y);
                if (dialogue) {
                    console.log('🍺 Bartender says:', dialogue);
                    // You could also display this in a UI dialog box
    ...
    showDialogue(message) {
        if (this.dialogueSystem) {
            ...
            // Fallback to console if dialogue system not available
            console.log('🍺 Bartender says:', message);
        }
    }
    render(ctx) {
    ...
    constructor(x, y){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dialogueSystem", null);
        this.x = x;
        this.y = y;
    }
}
...
class HokieHouseInterior extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    ...
    // Add interaction method for the bartender
    interactWithBartender(playerX, playerY) {
        const bartenderBounds = this.bartender.getBounds();
        const distance = Math.sqrt(Math.pow(playerX - (bartenderBounds.x + bartenderBounds.width / 2), 2) + Math.pow(playerY - (bartenderBounds.y + bartenderBounds.height / 2), 2));
        // If player is close enough (within 50 pixels)
        if (distance < 50) {
            return this.bartender.interact();
        }
        return null;
    }
    constructor(){
...
"[project]/app/components/DialogueSystem.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class DialogueSystem {
    ...
    render(ctx) {
        ...
        const boxWidth = Math.min(600, this.currentDialogue.length * 8 + 40);
        const boxHeight = 80;
        const boxX = (800 - boxWidth) / 2; // Center horizontally
        const boxY = 500; // Near bottom of screen
        // Background
        ...
        ctx.font = 'bold 14px sans-serif';
        ctx.textAlign = 'left';
        ctx.fillText('Bartender Jake:', boxX + 10, boxY + 20);
        // Dialogue text
        ctx.fillStyle = '#FFFFFF';
        ctx.font = '12px sans-serif';
        ...
        ctx.font = '10px sans-serif';
        ctx.textAlign = 'right';
        ctx.fillText('Press SPACE to close', boxX + boxWidth - 10, boxY + boxHeight - 10);
        // Restore context
        ctx.restore();
    }
    isActive() {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isDialogueActive", false);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "currentDialogue", '');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dialogueTimer", 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dialogueDuration", 3000); // 3 seconds
    }
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$DialogueSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/DialogueSystem.ts [app-client] (ecmascript)");
;
;
;
;
...
class GameEngine {
    ...
    constructor(canvas, ctx){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "inputHandler", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dialogueSystem", void 0);
        ...
        this.dialogueSystem = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$DialogueSystem$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogueSystem"]();
        // Connect dialogue system to player
        this.player.setDialogueSystem(this.dialogueSystem);
        // Bind the game loop
...
//# sourceMappingURL=app_0e2a9f94._.js.map