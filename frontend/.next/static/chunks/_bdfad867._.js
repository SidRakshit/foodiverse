...
class Player {
    ...
    canMoveTo(x, y, scene) {
        ...
        if (!canMove) {
            console.log('Movement blocked by scene collision:', {
                x,
                y,
...
class SceneManager {
    ...
    switchScene(newSceneType, entranceX, entranceY) {
        ...
        console.log("Switched to ".concat(newSceneType, " scene"));
    }
    ...
    checkBuildingEntrance() {
        ...
        for(let dy = -1; dy <= 1; dy++){
            for(let dx = -1; dx <= 1; dx++){
                var _world_getTileAt;
                const tileX = playerTileX + dx;
                const tileY = playerTileY + dy;
                if (world.getTileAt && ((_world_getTileAt = world.getTileAt(tileX, tileY)) === null || _world_getTileAt === void 0 ? void 0 : _world_getTileAt.type) === 'door') {
                    var _world_getTileAt1;
                    const buildingType = (_world_getTileAt1 = world.getTileAt(tileX, tileY)) === null || _world_getTileAt1 === void 0 ? void 0 : _world_getTileAt1.buildingType;
...
class GameEngine {
    ...
    constructor(canvas, ctx){
        ...
        this.sceneManager = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$SceneManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](this.player);
...
//# sourceMappingURL=_bdfad867._.js.map