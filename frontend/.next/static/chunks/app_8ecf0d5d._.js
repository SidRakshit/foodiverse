...
if ("TURBOPACK compile-time truthy", 1) {
    setTimeout(async ()=>{
        ...
        if (result.success) {
            ...
            console.error('🔧 To fix: Make sure to run "cd backend && npm start" in a separate terminal');
        }
    }, 1000);
}
...
class FridgeManager {
    ...
    setupMockAuth() {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$ApiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].setAuthToken(mockToken);
    }
    ...
    getBuildingId(fridgeId) {
        // Map fridge IDs to building IDs
        const buildingMap = {
            'edge': 'edge-building-001',
            'techterrace': 'techterrace-building-001'
        };
        return buildingMap[fridgeId] || 'unknown-building';
    }
    ...
    handleFridgeUIInput(inputHandler, fridgeManager) {
        ...
        if (canModify) {
            ...
            if (inputHandler.wasKeyJustPressed('KeyR')) {
                ...
                fridgeManager.forceRefresh().then(()=>{
...
//# sourceMappingURL=app_8ecf0d5d._.js.map