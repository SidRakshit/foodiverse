...
class ApiService {
    ...
    async makeRequest(endpoint) {
        ...
        console.log("📡 Making ".concat(options.method || 'GET', " request to:"), url);
        try {
            ...
            if (!response.ok) {
                console.warn("❌ API request failed with status ".concat(response.status, ":"), url);
                const errorData = await response.json().catch(()=>({
                        error: 'Network error'
                    }));
                this.isOffline = response.status >= 500;
                return {
                    error: errorData.error || "HTTP ".concat(response.status, ": ").concat(response.statusText)
                };
            }
            ...
            } else if ((_error_message = error.message) === null || _error_message === void 0 ? void 0 : _error_message.includes('fetch')) {
    ...
    async getFridgeItems(apartmentId, buildingId) {
        ...
        const endpoint = "/listings".concat(queryParams.toString() ? "?".concat(queryParams.toString()) : '');
    ...
    async deleteFridgeItem(itemId) {
        return this.makeRequest("/listings/".concat(itemId), {
            method: 'DELETE'
        });
    }
    // Legacy endpoints for compatibility
    async claimItem(itemId) {
        return this.makeRequest("/listings/".concat(itemId, "/claim"), {
            method: 'PUT'
        });
    }
    // Health check
    async ping() {
        try {
            ...
            const response = await fetch("".concat(this.baseUrl, "/listings/health"), {
                signal: controller.signal,
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
    ...
    async testConnection() {
        try {
            ...
            if (!basicResponse.ok) {
                return {
                    success: false,
                    message: "Backend server responded with ".concat(basicResponse.status, ": ").concat(basicResponse.statusText),
                    details: {
            ...
            if (!healthCheck) {
                return {
                    ...
                    details: {
                        healthEndpoint: "".concat(this.baseUrl, "/listings/health")
                    }
                };
            }
            return {
    ...
    constructor(){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isOffline", false);
        this.baseUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://localhost:8080';
...
"[project]/app/components/FridgeManager.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class FridgeManager {
    ...
    setPlayerApartment(apartmentId) {
        ...
        console.log("🏠 Player apartment set to: ".concat(apartmentId));
    }
    ...
    determinePlayerApartment() {
        ...
        console.log("🏠 Player lives in: ".concat(this.playerApartment, " apartment"));
    }
    // UI State Management
    ...
    async addItem(fridgeId, item, playerId) {
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$ApiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].addFridgeItem({
                item_name: item.name,
            ...
            if (response.error) {
                ...
                const newItem = {
                    ...item,
                    id: "local-".concat(item.category, "-").concat(Date.now(), "-").concat(Math.random().toString(36).substr(2, 9)),
                    dateAdded: new Date(),
                    addedBy: playerId,
                    isLocalItem: true
                };
            ...
            console.log("Added item: ".concat(item.name, " to fridge ").concat(fridgeId, " by ").concat(playerId));
            return true;
        } catch (error) {
    ...
    async removeItem(fridgeId, itemId, playerId) {
        ...
        try {
            ...
            if (item.isLocalItem) {
                ...
                fridge.lastUpdated = new Date();
                console.log("Removed local item: ".concat(removedItem.name, " from fridge ").concat(fridgeId, " by ").concat(playerId));
                return true;
            }
            // Try to delete from database
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$ApiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].deleteFridgeItem(itemId);
            if (response.error) {
                console.warn('Failed to delete from database, removing locally:', response.error);
                const removedItem = fridge.items.splice(itemIndex, 1)[0];
                fridge.lastUpdated = new Date();
                console.log("Removed item locally: ".concat(removedItem.name, " from fridge ").concat(fridgeId, " by ").concat(playerId));
                return true;
            }
            // Success - refresh data
            await this.refreshFridgeData(fridgeId);
            fridge.lastUpdated = new Date();
            console.log("Removed item from database: ".concat(item.name, " from fridge ").concat(fridgeId, " by ").concat(playerId));
            return true;
        } catch (error) {
    ...
    renderFridgeUI(ctx, playerId) {
        ...
        // Connection status
        const isOnline = (fridge === null || fridge === void 0 ? void 0 : fridge.isOnline) !== false;
    ...
    renderInputField(ctx, x, y, width, height) {
        ...
        ctx.font = '10px Arial';
        ctx.textAlign = 'right';
        ctx.fillText("".concat(this.uiState.inputText.length, "/50"), x + width - 10, y + height - 5);
    }
    ...
    renderFridgeItem(ctx, item, x, y, width, height, isSelected) {
        ...
        if (item.status && item.status !== 'available') {
            statusText = " [".concat(item.status.toUpperCase(), "]");
        }
        if (item.isLocalItem) {
            statusText += ' [LOCAL]';
        } else if (!item.isLocalItem) {
        ...
        const addedText = "Added by ".concat(item.addedBy, " on ").concat(item.dateAdded.toLocaleDateString()).concat(statusText);
    ...
    async refreshFridgeData(fridgeId) {
        ...
        try {
            const fridge = this.fridgeData.get(fridgeId);
            if (!fridge) return;
            console.log("🔄 Refreshing fridge data for ".concat(fridgeId, "..."));
            // Get data from database
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$ApiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].getFridgeItems(fridge.apartmentId, this.getBuildingId(fridgeId));
            if (response.error) {
                ...
                console.log("✅ Refreshed fridge ".concat(fridgeId, " with ").concat(databaseItems.length, " database items and ").concat(localItems.length, " local items"));
            }
    ...
    async claimAndDeleteItem(itemId) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$ApiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].claimItem(itemId);
            if (response.error) {
    ...
    async isBackendAvailable() {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$ApiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].ping();
    }
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "fridgeData", new Map());
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "uiState", {
            isOpen: false,
            currentFridge: null,
            selectedItemIndex: 0,
            isInputMode: false,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isLoading", false);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "lastRefresh", new Map()); // Track last refresh time per fridge
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "refreshInterval", 30000); // 30 seconds
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "currentUser", 'player1'); // This should be set based on actual authentication
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "playerApartment", 'edge'); // Which apartment the player lives in (edge or techterrace)
        this.initializeDefaultFridges();
        this.determinePlayerApartment();
    }
}
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(FridgeManager, "instance", void 0);
const __TURBOPACK__default__export__ = FridgeManager;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/utils/BackendChecker.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class BackendChecker {
    static async checkBackendConnection() {
        if (this.hasShownWarning || "object" === 'undefined') return;
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$ApiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].testConnection();
            if (!result.success) {
            ...
            this.hasShownWarning = true;
            this.showBackendWarning('Failed to test backend connection', {
                error
            });
        }
    }
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(BackendChecker, "hasShownWarning", false);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@swc+helpers@0.5.15/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$FridgeManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/FridgeManager.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$BackendChecker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/utils/BackendChecker.ts [app-client] (ecmascript)");
;
;
;
class Player {
    update(deltaTime, inputHandler, scene) {
        ...
        const fridgeManager = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$FridgeManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getInstance();
    ...
    render(ctx) {
        ...
        if (this.nearbyFridge && !__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$FridgeManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getInstance().isFridgeUIOpen()) {
    ...
    renderPlayerName(ctx, playerX, playerY) {
        ...
        const pronounsWidth = pronounsText ? ctx.measureText("(".concat(pronounsText, ")")).width : 0;
        ...
        if (pronounsText) {
            ...
            ctx.fillText("(".concat(pronounsText, ")"), nameX, nameY + 5);
        }
        ctx.restore();
    }
    ...
    handleFridgeUIInput(inputHandler, fridgeManager) {
        ...
        if (canModify) {
            ...
            if (inputHandler.wasKeyJustPressed('KeyR')) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$utils$2f$BackendChecker$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BackendChecker"].retryConnection().then((connected)=>{
                    if (connected) {
    ...
    constructor(x, y, playerCharacter){
        ...
        // Chat functionality
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isChatting", false);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "currentMessage", '');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "displayMessage", '');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "messageTimer", 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "messageDuration", 3000); // 3 seconds
        // Interaction system
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "nearbyFridge", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "playerId", 'player1'); // This should be set based on actual player identity
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "nearbyJake", null);
        // Character data
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "playerCharacter", void 0);
        this.x = x;
        this.y = y;
...
"[project]/app/components/off-campus/NameBuildings.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class NameBuildings extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$BaseArea$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getAreaName() {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$NameBuildings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/NameBuildings.ts [app-client] (ecmascript)");
;
;
;
class World {
    ...
    constructor(){
        ...
        this.offCampusArea = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$NameBuildings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]();
    }
}
...
"[project]/app/components/campus/TurnerInterior.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class TurnerInterior extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$campus$2f$BaseBuildingInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'turner');
    }
}
...
"[project]/app/components/off-campus/BaseOffCampusBuilding.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class BaseOffCampusBuilding {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "tileSize", 32);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "buildingWidth", 20); // tiles
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "buildingHeight", 15); // tiles
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "tiles", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "cameraX", 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "cameraY", 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "exitX", 320); // Default exit position
...
"[project]/app/components/off-campus/TotsDownstairs.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@swc+helpers@0.5.15/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/BaseOffCampusBuilding.ts [app-client] (ecmascript)");
;
;
class TotsDownstairs extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'tots');
    }
}
...
"[project]/app/components/off-campus/TotsUpstairs.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class TotsUpstairs extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'tots_upstairs');
    }
}
...
"[project]/app/components/NPC.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class BaseNPC {
    ...
    constructor(config){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dialogues", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "currentDialogue", 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "color", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "clothingColor", void 0);
        this.x = config.x;
        this.y = config.y;
...
"[project]/app/services/JakeService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class JakeService {
    async chatWithJake(playerMessage) {
        try {
            console.log('🗣️ JakeService: Sending message to Jake: "'.concat(playerMessage, '"'));
            console.log("🗣️ JakeService: Using baseUrl: ".concat(this.baseUrl));
            ...
            console.log("🗣️ JakeService: Making fetch request to ".concat(this.baseUrl, "/jake/chat"));
            const response = await fetch("".concat(this.baseUrl, "/jake/chat"), {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            console.log("🗣️ JakeService: Got response status: ".concat(response.status));
            if (!response.ok) {
                console.error("🚨 JakeService: HTTP error ".concat(response.status));
            ...
            console.log("🍺 JakeService: Returning Jake's response: \"".concat(jakeResponse.message, '"'));
    ...
    async isAvailable() {
        try {
            const response = await fetch("".concat(this.baseUrl, "/jake/status"));
            return response.ok;
        } catch (e) {
            return false;
        }
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "baseUrl", void 0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "conversationHistory", []);
        this.baseUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://localhost:8080';
    }
}
...
"[project]/app/components/off-campus/BartenderNPC.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@swc+helpers@0.5.15/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$NPC$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/NPC.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$JakeService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/services/JakeService.ts [app-client] (ecmascript)");
;
;
;
class BartenderNPC extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$NPC$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseNPC"] {
    update(deltaTime) {
    ...
    async respondToPlayer(playerMessage) {
        ...
        console.log('🍺 Jake received message from player: "'.concat(playerMessage, '"'));
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$JakeService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jakeService"].chatWithJake(playerMessage);
            ...
            console.log('🍺 Jake will display response: "'.concat(response, '"'));
        } catch (error) {
    ...
    constructor(x, y){
        ...
        super(config), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "isThinking", false), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "currentResponse", ''), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "responseTimer", 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "responseDuration", 4000) // 4 seconds
        , (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "thinkingTimer", 0), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "thinkingDuration", 2000) // 2 seconds thinking time
        ;
    }
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/app/components/off-campus/HokieHouseInterior.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@swc+helpers@0.5.15/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/BaseOffCampusBuilding.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BartenderNPC$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/BartenderNPC.ts [app-client] (ecmascript)");
;
;
;
class HokieHouseInterior extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(){
        super(), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'hokiehouse'), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "bartender", void 0);
        // Position bartender near the bottles and bar area (left side)
        this.bartender = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BartenderNPC$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BartenderNPC"](80, 170);
    }
}
...
"[project]/app/components/off-campus/CentrosInterior.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class CentrosInterior extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'centros');
    }
}
...
"[project]/app/components/off-campus/EdgeInterior.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class EdgeInterior extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'edge');
    }
}
...
"[project]/app/components/off-campus/TechTerraceInterior.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class TechTerraceInterior extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'techterrace');
    }
}
...
"[project]/app/components/off-campus/FoodLionInterior.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class FoodLionInterior extends __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$BaseOffCampusBuilding$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    getBuildingName() {
    ...
    constructor(...args){
        super(...args), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "type", 'foodlion');
    }
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$campus$2f$TurnerInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/campus/TurnerInterior.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$TotsDownstairs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/TotsDownstairs.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$TotsUpstairs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/TotsUpstairs.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$HokieHouseInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/HokieHouseInterior.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$CentrosInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/CentrosInterior.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$EdgeInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/EdgeInterior.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$TechTerraceInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/TechTerraceInterior.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$FoodLionInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/off-campus/FoodLionInterior.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$FridgeManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/FridgeManager.ts [app-client] (ecmascript)");
;
;
;
...
class SceneManager {
    initializeScenes() {
        ...
        this.scenes.set('turner', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$campus$2f$TurnerInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
        ...
        this.scenes.set('tots', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$TotsDownstairs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
        this.scenes.set('tots_upstairs', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$TotsUpstairs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
        this.scenes.set('hokiehouse', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$HokieHouseInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
        this.scenes.set('centros', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$CentrosInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
        // Off-campus apartment interiors
        this.scenes.set('edge', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$EdgeInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
        this.scenes.set('techterrace', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$TechTerraceInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
        // Off-campus commercial interiors
        this.scenes.set('foodlion', new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$off$2d$campus$2f$FoodLionInterior$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]());
    }
    getCurrentScene() {
        ...
        if (exitInfo) {
            ...
            if (distance < 30) {
                ...
                if (this.lastBuildingEntry) {
                    ...
                    console.log("Exited building by walking to door: (".concat(exitX, ", ").concat(exitY, ")"));
                } else {
    ...
    exitToOutside() {
        ...
        if (this.lastBuildingEntry) {
            ...
            const exitY = (this.lastBuildingEntry.tileY + 1) * 32; // One tile below the door
            this.switchScene('campus', exitX, exitY);
            console.log("Exited building to position below door: (".concat(exitX, ", ").concat(exitY, ")"));
        } else {
    ...
    constructor(player, inputHandler){
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "lastBuildingEntry", null);
        this.player = player;
...
class GameEngine {
    ...
    constructor(canvas, ctx, playerCharacter){
        ...
        this.player = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$Player$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](400, 912, playerCharacter); // Starting position in campus area (608 + 304)
...
"[project]/app/components/CharacterData.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/components/CharacterSelection.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/CharacterData.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
;
const CharacterSelection = (param)=>{
    let { onCharacterSelected } = param;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CharacterSelection.useEffect": ()=>{
            const handleKeyPress = {
                "CharacterSelection.useEffect.handleKeyPress": (e)=>{
                    if (isEnteringCustomPronouns) {
                        if (e.key === 'Enter') {
                            ...
                            setCustomPronouns({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>prev.slice(0, -1)
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        } else if (e.key.length === 1 && customPronouns.length < 15) {
                            setCustomPronouns({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>prev + e.key
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        }
                    } else if (isSelectingGender) {
                        if (e.key === 'ArrowUp' || e.key === 'KeyW') {
                            setSelectedGenderIndex({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>(prev - 1 + __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GENDER_OPTIONS"].length) % __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GENDER_OPTIONS"].length
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        } else if (e.key === 'ArrowDown' || e.key === 'KeyS') {
                            setSelectedGenderIndex({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>(prev + 1) % __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GENDER_OPTIONS"].length
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        } else if (e.key === 'Enter') {
                            const selected = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GENDER_OPTIONS"][selectedGenderIndex];
                        ...
                        if (e.key === 'ArrowRight' || e.key === 'KeyD') {
                            setSelectedIndex({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>(prev + 1) % __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"].length
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        } else if (e.key === 'ArrowLeft' || e.key === 'KeyA') {
                            setSelectedIndex({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>(prev - 1 + __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"].length) % __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"].length
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        } else if (e.key === 'ArrowDown' || e.key === 'KeyS') {
                            setSelectedIndex({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>(prev + 4) % __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"].length
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        } else if (e.key === 'ArrowUp' || e.key === 'KeyW') {
                            setSelectedIndex({
                                "CharacterSelection.useEffect.handleKeyPress": (prev)=>(prev - 4 + __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"].length) % __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"].length
                            }["CharacterSelection.useEffect.handleKeyPress"]);
                        } else if (e.key === 'Enter') {
                            setIsSelectingGender(true);
                        }
            ...
            return ({
                "CharacterSelection.useEffect": ()=>window.removeEventListener('keydown', handleKeyPress)
            })["CharacterSelection.useEffect"];
        }
    }["CharacterSelection.useEffect"], [
        isEnteringName,
    ...
    const handleStartGame = ()=>{
        ...
        const characterData = {
            selectedCharacter: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"][selectedIndex],
            playerName: playerName.trim(),
            selectedGender: selectedGender,
            customPronouns: (selectedGender === null || selectedGender === void 0 ? void 0 : selectedGender.id) === 'custom' ? customPronouns : undefined,
            showPronouns: selectedGender ? selectedGender.id !== 'prefer-not' : false
        };
        onCharacterSelected(characterData);
    };
    const renderCharacterPreview = function(character) {
        let scale = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 6;
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mb-8",
                        children: renderCharacterPreview(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"][selectedIndex], 8)
                    }, void 0, false, {
                        fileName: "[project]/app/components/CharacterSelection.tsx",
                        lineNumber: 168,
                        columnNumber: 11
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GENDER_OPTIONS"].map((gender, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "p-3 border-2 rounded-lg transition-all text-left ".concat(selectedGenderIndex === index ? 'border-orange-400 bg-orange-900 bg-opacity-20' : 'border-gray-600'),
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"].map((character, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "character-option p-4 border-2 rounded-lg transition-all ".concat(selectedIndex === index ? 'border-orange-400 bg-orange-900 bg-opacity-20' : 'border-gray-600'),
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                "Character ",
                                __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHARACTER_OPTIONS"][selectedIndex].number
                            ]
                        }, void 0, true, {
                            fileName: "[project]/app/components/CharacterSelection.tsx",
                            lineNumber: 302,
...
_s(CharacterSelection, "l99jc92DFJui7g7Cj6X7jXJDibw=");
_c = CharacterSelection;
const __TURBOPACK__default__export__ = CharacterSelection;
var _c;
__turbopack_context__.k.register(_c, "CharacterSelection");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterSelection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/CharacterSelection.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const Game = ()=>{
        ...
        "Game.useEffect": ()=>{
            if (canvasRef.current && !gameEngineRef.current && playerCharacter && !showCharacterSelection) {
                ...
                if (ctx) {
                    ...
                    gameEngineRef.current = new __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$GameEngine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](canvas, ctx, playerCharacter);
    ...
    if (showCharacterSelection) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$4_react$2d$dom$40$19$2e$1$2e$0_react$40$19$2e$1$2e$0_$5f$react$40$19$2e$1$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CharacterSelection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(Game, "IhlI6ybx6KLPKMd6D8K+469C8T4=");
_c = Game;
...
//# sourceMappingURL=app_95f6c371._.js.map